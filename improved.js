addEventListener('fetch', async (event) => {
  try {
    ...
    url.hostname = 'connectvip.ml'; // In domain name, don't add http or https prefix, just the direct domain name
    ...
    event.respondWith(new Response('An error occurred.', { status: 500 }));
  }
});
